...
# def batch_warp3d_3c(imgs, mappings):
#     """
#     warp image using mapping function
#     I(x) -> I(phi(x))
#     phi: mapping function
...
#
#     output = _interpolate3d_3c(imgs, x_coords_flat, y_coords_flat, z_coords_flat)
#     return output

def batch_warp3d(imgs, mappings,num_batch=1,x=96,y=96,z=96):
    """
    warp image using mapping function
    I(x) -> I(phi(x))
    phi: mapping function
...
# def _interpolate3d_3c(imgs, x, y, z):
